...
const projectsData = [
  {
    ...
    id: 1,
    year: 2015,
    image: 'images/Snapshoot-Portfolio-1-mobile.svg',
    ...
    liveVersion: 'https://alierpm.github.io/',
    source: 'https://github.com/AlierPM/Portfolio',
  },
  {
    ...
    id: 2,
    year: 2020,
    image: 'images/Snapshoot-Portfolio-2-mobile.svg',
    technologies: ['html', 'css', 'javascript'],
    description:
      'Lorem Ipsum is simply dummy text of the printing and typesetting industry.'
      + "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, "
...

  {
    ...
    year: 2019,
    id: 3,
    image: 'images/Snapshoot-Portfolio-3-mobile.svg',
    technologies: ['html', 'css', 'javascript'],
    description:
      'Lorem Ipsum is simply dummy text of the printing and typesetting industry.'
      + "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, "
...

  {
    ...
    year: 2020,
    id: 4,
    image: 'images/Snapshoot-Portfolio-4-mobile.svg',
    technologies: ['html', 'css', 'javascript'],
    description:
      'Lorem Ipsum is simply dummy text of the printing and typesetting industry.'
      + "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, "
